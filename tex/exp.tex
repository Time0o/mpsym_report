...
\begin{figure}
  \centering
    \includegraphics[width=.4\textwidth]{resources/pdf/exynos.pdf}
...
\begin{figure}
  \centering
    \includegraphics[width=.45\textwidth]{resources/pdf/parallella.pdf}
...
\begin{figure}
  \centering
    \includegraphics[width=.6\textwidth]{resources/pdf/haec.pdf}
...
\begin{figure}
  \centering
    \includegraphics[width=\textwidth]{resources/pdf/kalray.pdf}
...
\begin{figure}
  \centering
  \input{resources/tex/gap_boxplot.tex}
  \input{resources/tex/mpsym_boxplot.tex}
...
\begin{figure}
  \centering
  \input{resources/tex/exynos_lineplot.tex}
  \caption{TMOR results for the Exynos architecture.}
  \label{fig:exynos_lineplot}
  %
  \vspace{1cm}
  %
  \input{resources/tex/parallella_lineplot.tex}
...
\begin{figure}
  \centering
  \input{resources/tex/haec_lineplot.tex}
  ...
  \vspace{1cm}
  %
  \input{resources/tex/haec_histogram.tex}
...
\begin{figure}
  \input{resources/tex/kalray_lineplot.tex}
