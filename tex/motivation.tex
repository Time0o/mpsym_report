...
\begin{figure}
  \centering
    \includegraphics[width=.5\textwidth]{resources/pdf/regular_mesh_m_n.pdf}
...
\begin{figure}
  ...
  \begin{subfigure}{.4\textwidth}
    \includegraphics[width=\textwidth]{resources/pdf/regular_mesh_4_4_mapping1.pdf}
    \caption{}
  \end{subfigure}
  \hspace*{\fill}
  \begin{subfigure}{.4\textwidth}
    \includegraphics[width=\textwidth]{resources/pdf/regular_mesh_4_4_mapping2.pdf}
    \caption{}
  \end{subfigure}
  %\\ \\ \\
  \begin{subfigure}{.4\textwidth}
    \includegraphics[width=\textwidth]{resources/pdf/regular_mesh_4_4_mapping4.pdf}
    \caption{}
  \end{subfigure}
  \hspace*{\fill}
  \begin{subfigure}{.4\textwidth}
    \includegraphics[width=\textwidth]{resources/pdf/regular_mesh_4_4_mapping5.pdf}
    \caption{}
  \end{subfigure}
